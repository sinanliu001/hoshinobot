...
CHARA_NAME = {
    ...
    1155: ["可可萝(祭服)", "コッコロ(儀装束)", "Kokkoro(Costume)", "可可萝(礼服)", "可可萝(仪装束)", "礼妈", "仪妈", "仪装妈", "姨妈", "礼白"],
    1156: ["优衣(祭服)", "ユイ(儀装束)", "Yui(Costume)", "优衣(礼服)", "优衣(仪装束)", "礼ue", "礼装ue", "礼装优衣", "仪装ue", "礼衣", "礼田"],
    ...
    1162: ["克萝依(圣学祭)", "クロエ(聖学祭)", "Kuroe(Seigakusai)", "克罗依(圣学祭)", "运动华", "运动华哥", "圣学祭华", "圣学祭克萝依", "圣华"],
    ...
    1238: ["克莉丝提娜(狂野)", "クリスティーナ(ワイルド)", "Kurisutiina(Wild)", "兔克", "兔女郎克", "野克"],
    ...
    1262: ["伊莉亚(祭服)", "イリヤ(儀装束)", "Ilya(Costume)", "伊莉亚(礼服)", "礼装伊莉亚", "礼装伊莉雅", "礼装伊利亚", "礼装yly", "礼服伊莉亚", "礼服伊莉雅", "礼服伊利亚", "礼服yly", "礼亚"],
    1263: ["雪(祭服)", "ユキ(儀装束)", "Yuki(Costume)", "雪(礼服)", "礼雪", "礼服雪", "礼服雪哥"],
    1264: ["克萝茜", "クローチェ", "Croce", "机娘"], 
    1265: ["莱拉耶尔", "ライラエル", "Lyrael", "傲慢", "傲慢姬", "莱莱"],
    ...
    1272: ["凯留(插班生)", "キャル(編入生)", "Kyaru(Transfer Student)", "凯露(插班生)", "学猫", "偷腥猫"],
    1273: ["铃奈(插班生)", "スズナ(編入生)", "Suzuna(Transfer Student)", "学暴", "雪豹"],

    1275: ["咲恋(萨拉萨利亚)", "サレン(サラサリア)", "Saren(Salasaria)", "火电", "火电站", "火舞旋风"],
    1276: ["流夏(萨拉萨利亚)", "ルカ(サラサリア)", "Ruka(Salasaria)", "流沙", "沙漠流夏"],


    1279: ["贪吃佩可(圣诞节)", "ペコリーヌ(クリスマス)", "Pecorine(Christmas)", "圣吃", "剩饭", "圣诞吃货", "圣诞佩可"],
    1280: ["克蕾琪塔(圣诞节)", "クレジッタ(クリスマス)", "Creditta(Christmas)", "圣诞富婆", "圣婆", "圣富婆"],
    ...
    1290: ["厄里斯", "エリス", "Elis", "els"],


    1293:["优妮(冬日)", "ユニ(ウィンター)", "Yuni(Winter)", "水un", "水优妮", "水油腻", "水辈先"],
    1294:["克萝依(冬日)", "クロエ(ウィンター)", "Kuroe(Winter)", "水华哥", "水华"],

    1296:["安涅默涅", "アネモネ", "Anemone", "银莲", "银莲花"],
    1297:["涅妃涅菈", "ネフィ＝ネラ", "Nefi Nera"],
    ...
    1307:["镜华(春日)", "キョウカ(スプリング)", "Kyouka(Spring)", "花唯", "花仓唯", "花cw"],
...
CHARA_PROFILE = {
    ...
    1258: {"名字": "莉莉", "公会": "Alter Maiden", "生日": "4月29日", "年龄": "15", "身高": "154cm", "体重": "44kg", "血型": "A", "种族": "人族", "喜好": "插花、读书(古籍)、东国画", "声优": "铃木实里"},
    1260: {"名字": "可璃亚", "公会": "Alter Maiden", "生日": "11月1日", "年龄": "13", "身高": "147cm", "体重": "42kg", "血型": "O", "种族": "人族", "喜好": "做点心、照顾花朵、演奏小提琴", "声优": "前田佳织里"},
    1261: {"名字": "普蕾西亚", "公会": "Alter Maiden", "生日": "3月1日", "年龄": "10", "身高": "135cm", "体重": "34kg", "血型": "O", "种族": "兽人族", "喜好": "吃饭", "声优": "高尾奏音"},
    1264: {"名字": "克萝茜", "公会": "？？？", "生日": "11月11日", "年龄": "？？？", "身高": "170cm", "体重": "未换装时252kg", "血型": "？", "种族": "机械人族", "喜好": "睡午觉、对别人有益之事", "声优": "长谷川育美"},
    1265: {"名字": "莱拉耶尔", "公会": "ジオ・テオグニア", "生日": "1月17日", "年龄": "？？？", "身高": "162cm", "体重": "？？？kg", "血型": "？", "种族": "天使族", "喜好": "睡午觉、试吃新甜点", "声优": "河瀬茉希"},
