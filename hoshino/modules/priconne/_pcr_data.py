...
CHARA_NAME = {
    ...
    1084: ["千歌(圣诞节)", "チカ(クリスマス)", "Chika(Xmas)", "Chika(Holiday)", "圣诞千歌", "圣千", "蛋鸽", "🎄💰🎶", "🎄千🎶", "🎄1000🎶"],
    1085: ["胡桃(圣诞节)", "クルミ(クリスマス)", "Kurumi(Xmas)", "Kurumi(Holiday)", "圣诞胡桃", "圣诞铃铛"],
    1086: ["绫音(圣诞节)", "アヤネ(クリスマス)", "Ayane(Xmas)", "Ayane(Holiday)", "圣诞熊锤", "蛋锤", "圣锤", "🎄🐻🔨", "🎄🐻"],
    ...
    1111: ["镜华(万圣节)", "キョウカ(ハロウィン)", "Kyouka(Halloween)", "Kyoka(Halloween)", "万圣镜华", "万圣小仓唯", "万圣xcw", "猫仓唯", "黑猫仓唯", "mcw", "猫唯", "猫仓", "喵唯"],
    ...
    1115: ["克莉丝提娜(圣诞节)", "クリスティーナ(クリスマス)", "Kurisutiina(Xmas)", "Christina(Xmas)", "Cristina(Xmas)", "Christina(Holiday)", "圣诞克", "圣诞克总", "圣诞女帝", "蛋克", "蛋壳", "圣克", "必胜客"],
    1116: ["望(圣诞节)", "ノゾミ(クリスマス)", "Nozomi(Xmas)", "Nozomi(Holiday)", "圣诞望", "圣诞偶像", "蛋偶像", "蛋望"],
    1117: ["伊莉亚(圣诞节)", "イリヤ(クリスマス)", "Iriya(Xmas)", "Illya(Holiday)", "圣诞伊莉亚", "圣诞伊利亚", "圣诞伊莉雅", "圣诞伊利雅", "圣诞yly", "圣诞吸血鬼", "圣伊", "圣yly", "伊利丹"],
    ...
    1122: ["霞(魔法少女)", "カスミ(マジカル)", "Kasumi(MagiGirl)", "Kasumi(Magical)", "魔法少女霞", "魔法侦探", "魔法杜宾犬", "魔法驴", "魔法驴子", "魔驴", "魔法霞", "魔法少驴"],
    1123: ["栞(魔法少女)", "シオリ(マジカル)", "Shiori(MagiGirl)", "Shiori(Magical)", "魔法少女栞", "魔法tp弓", "魔法小栞", "魔法白虎弓", "魔法白虎妹", "魔法白虎", "魔栞", "魔弓", "魔法弓", "法弓"],
    1124: ["卯月(NGs)", "ウヅキ(デレマス)", "Udsuki(DEREM@S)", "Uzuki(IM@S CG)", "Uzuki(Deremasu)", "卯月(偶像大师)", "卯月", "卵用", "Udsuki(DEREMAS)", "岛村卯月", "Udsuki"],
    1125: ["凛(NGs)", "リン(デレマス)", "Rin(DEREM@S)", "Rin(IM@S CG)", "Rin(Deremasu)", "凛(偶像大师)", "凛", "Rin(DEREMAS)", "涩谷凛", "西部凛"],
    1126: ["未央(NGs)", "ミオ(デレマス)", "Mio(DEREM@S)", "Mio(IM@S CG)", "Mio(Deremasu)", "未央(偶像大师)", "未央", "Mio(DEREMAS)", "本田未央", "Mio"],
    ...
    1129: ["璃乃(奇幻)", "リノ(ワンダー)", "Rino(Wonder)", "Rino(Wonderland)", "璃乃(奇境)", "璃乃(仙境)", "爽弓", "爱丽丝弓", "爱弓", "兔弓", "奇境妹弓", "奇幻妹弓", "奇幻璃乃", "仙境妹弓", "白丝妹弓", "爱丽丝妹弓"],
    1130: ["步未(奇幻)", "アユミ(ワンダー)", "Ayumi(Wonder)", "Ayumi(Wonderland)", "步未(奇境)", "步未(仙境)", "路人兔", "兔人妹", "爱丽丝路人", "奇境路人", "奇幻路人", "奇幻步未", "仙境路人", "爱丽丝路人妹", "梦路", "步美(仙境)"],
    ...
    1155: ["可可萝(祭服)", "コッコロ(儀装束)", "Kokkoro(Costume)", "Kokkoro(Ceremonial)", "可可萝(礼服)", "可可萝(仪装束)", "礼妈", "仪妈", "仪装妈", "姨妈", "礼白"],
    1156: ["优衣(祭服)", "ユイ(儀装束)", "Yui(Costume)", "Yui(Ceremonial)", "优衣(礼服)", "优衣(仪装束)", "礼ue", "礼装ue", "礼装优衣", "仪装ue", "礼衣", "礼田"],
    1157: ["霞(夏日)", "カスミ(サマー)", "Kasumi(Summer)", "香澄(夏日)", "水驴", "泳装驴", "沪"],
    1158: ["莉玛(灰姑娘)", "リマ(シンデレラ)", "Rima(Cinderella)", "Lima(Cinderella)", "人形羊驼", "人驼", "灰驼", "灰姑娘羊驼", "灰羊"],
    1159: ["真琴(灰姑娘)", "マコト(シンデレラ)", "Makoto(Cinderella)", "灰姑娘狼", "灰狼"],
    1160: ["真步(灰姑娘)", "マホ(シンデレラ)", "Maho(Cinderella)", "灰姑娘狐狸", "灰狐狸", "灰狐", "灰壶", "茶狐", "茶壶"],

    1162: ["克萝依(圣学祭)", "クロエ(聖学祭)", "Kuroe(Seigakusai)", "Chloe(SchoolFestival)", "克罗依(圣学祭)", "运动华", "运动华哥", "圣学祭华", "圣学祭克萝依", "圣华"],
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(Seigakusai)", "Chieru(SchoolFestival)", "千爱瑠(圣学祭)", "运动切噜", "圣学祭切噜", "圣学祭琪爱儿", "圣学祭千爱瑠", "圣爱瑠"],
    1164: ["优妮(圣学祭)", "ユニ(聖学祭)", "Yuni(Seigakusai)", "Yuni(SchoolFestival)", "圣优妮", "圣uni", "运动优妮", "运动服", "罗塞塔"],
    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "Inori(TimeTraveller)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八"],
    1166: ["嘉夜(时间旅行)", "カヤ(タイムトラベル)", "Kaya(TimeTravel)", "Kaya(TimeTraveller)", "时间旅行龙拳", "穿越龙拳", "水手龙", "水手龙拳", "时空龙拳"],
    1167: ["碧(作业服)", "アオイ(作業服)", "Aoi(Sagyoufuku)", "Aoi(Work)", "碧(工作服)", "工菜", "韭菜", "工作碧", "贡菜"],
    1168: ["珠希(作业服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "Tamaki(Work)", "珠希(工作服)", "工猫贼", "工猫剑", "工贼", "工珠希"],
    1169: ["美冬(作业服)", "ミフユ(作業服)", "Mifuyu(Sagyoufuku)", "Mifuyu(Work)", "美冬(工作服)", "电子龙", "工子龙", "工龙", "工头"],
    ...
    1178: ["妮诺(万圣节)", "ニノン(ハロウィン)", "Ninon(Halloween)", "妮侬(万圣节)", "万圣扇", "瓜扇", "万圣扇子"],
    ...
    1192: ["真阳(圣诞节)", "マヒル(クリスマス)", "Mahiru(Xmas)", "Mahiru(Holiday)", "圣牛", "蛋牛", "圣诞奶牛", "圣诞牛"],
    1193: ["璃乃(圣诞节)", "リノ(クリスマス)", "Rino(Xmas)", "Rino(Holiday)", "圣诞妹弓", "圣诞璃乃", "弹弓", "蛋弓", "诞弓"],





    1199: ["宫子(圣诞节)", "ミヤコ(クリスマス)", "Miyako(Xmas)", "Miyako(Holiday)", "圣诞布丁", "圣诞宫子", "诞丁", "蛋丁", "但丁"],
    1200: ["静流(黑暗)", "シズル(ノワール)", "Shizuru(Noir)", "黑姐姐", "黑姐"],
    ...
    1207: ["雪菲(新年)", "シェフィ(ニューイヤー)", "Shephy(NewYear)", "Shefi(NewYear)", "Sheffy(NewYear)", "新年雪菲", "春雪菲", "春菲", "春冰龙"],
    1208: ["流夏(新年)", "ルカ(ニューイヤー)", "Ruka(NewYear)", "春流夏", "春流"],
    1209: ["伊莉亚(新年)", "イリヤ(ニューイヤー)", "Iriya(NewYear)", "Illya(NewYear)", "新年伊莉亚", "新年伊利亚", "新年伊莉雅", "新年伊利雅", "新年yly", "新年吸血鬼", "春伊", "春yly", "伊莉旦"],
    1210: ["贪吃佩可(超载)", "ペコリーヌ(オーバーロード)", "Pecorine(Overload)", "Pekoriinu(Overload)", "佩可莉姆(超负荷)", "超载吃", "超吃", "超载佩可", "超载佩", "超佩"],
    1211: ["凯留(超载)", "キャル(オーバーロード)", "Karyl(Overload)", "凯露(超载)", "Kyaru(Overload)", "凯露(超负荷)", "超载凯留", "超凯留", "超载黑猫", "超黑", "超猫", "超威蓝猫"],
    1212: ["拉比林斯达(超载)", "ラビリスタ(オーバーロード)", "Labyrista(Overload)", "Rabirisuta(Overload)", "菈比莉斯塔(超负荷)", "超载晶", "超晶"],
    1213: ["胡桃(舞台)", "クルミ(ステージ)", "Kurumi(Stage)", "舞台胡桃", "舞桃", "演员", "舞胡", "芜湖", "舞铃", "舞台铃", "戏铃"],
    1214: ["美咲(舞台)", "ミサキ(ステージ)", "Misaki(Satge)", "舞台大眼", "舞台眼", "舞台美咲", "泥头车大眼", "车眼"],
    1215: ["步未(怪盗)", "アユミ(怪盗)", "Ayumi(Kaitou)", "Ayumi(PhantomThief)", "怪盗路人", "怪盗路人妹"],
    1216: ["祈梨(怪盗)", "イノリ(怪盗)", "Inori(Kaitou)", "Inori(PhantomThief)", "怪盗祈梨", "怪盗龙锤", "忍龙", "忍龙锤"],
    1217: ["秋乃(秋乃&咲恋)", "アキノ(アキノ&サレン)", "Akino(Akino&Saren)"],
    1218: ["咲恋(秋乃&咲恋)", "サレン(アキノ&サレン)", "Saren(Akino&Saren)"],
    1219: ["杏奈(海盗)", "アンナ(パイレーツ)", "Anna(Pirates)", "Anna(Pirate)", "海盗中二", "海盗杏奈", "船长中二", "船二"],
    1220: ["忍(海盗)", "シノブ(パイレーツ)", "Shinobu(Pirates)", "Shinobu(Pirate)", "海盗忍", "海贼忍", "海忍", "水手忍", "手忍"],
    1221: ["碧(露营)", "アオイ(キャンプ)", "Aoi(Camp)", "露营碧", "露碧", "野菜"],
    1222: ["优花梨(露营)", "ユカリ(キャンプ)", "Yukari(Camp)", "由加莉(露营)", "露营优花梨", "露优花梨", "露花梨", "露营黄骑", "露黄骑", "露黄"],
    1223: ["斑比", "ヴァンピィ", "Vampy", "Vania", "斑比酱", "钉宫"],
    1224: ["日和(夏日)", "ヒヨリ(サマー)", "Hiyori(Summer)", "日和莉(夏日)", "水猫拳", "水日和"],
    1225: ["怜(夏日)", "レイ(サマー)", "Rei(Summer)", "水怜", "水剑圣"],
    1226: ["优衣(夏日)", "ユイ(サマー)", "Yui(Summer)", "水优衣", "水ue", "水田", "泳衣", "游依", "水草"],
    1227: ["镜华(夏日)", "キョウカ(サマー)", "Kyouka(Summer)", "Kyoka(Summer)", "泳装镜华", "水镜华", "水xcw", "水仓唯", "水cw", "scw"],
    1228: ["禊(夏日)", "ミソギ(サマー)", "Misogi(Summer)", "未奏希(夏日)", "水禊", "水炸弹人", "水炸", "水未奏希", "泳装炸弹人", "泳装未奏希"],
    1229: ["美美(夏日)", "ミミ(サマー)", "Mimi(Summer)", "水美美", "泳装美美", "水兔", "水兔兔", "水兔子"],
    1230: ["爱梅斯", "アメス", "Amesu", "Ameth", "ams", "菲欧", "爱美斯", "艾美斯", "艾梅斯"],
    1231: ["真步(探险家)",  "マホ(エクスプローラー)", "Maho(Explorer)", "真步(探索者)", "野狐", "探狐", "尻狐", "屁狐", "屁胡"],
    1232: ["绫音(探险家)", "アヤネ(エクスプローラー)", "Ayane(Explorer)", "绫音(探索者)", "野锤", "野炊"],
    ...
    1238: ["克莉丝提娜(狂野)", "クリスティーナ(ワイルド)", "Kurisutiina(Wild)", "Christina(Wild)", "兔克", "兔女郎克", "野克"],
    1239: ["茉莉(狂野)", "マツリ(ワイルド)", "Matsuri(Wild)", "小虎", "野老虎"],
    1240: ["茜里(圣诞节)", "アカリ(クリスマス)", "Akari(Xmas)", "Akari(Holiday)", "圣妹", "圣诞妹法"],
    1241: ["依里(圣诞节)", "ヨリ(クリスマス)", "Yori(Xmas)", "Yori(Holiday)", "圣姐", "圣诞姐法"],
    1242: ["纯(圣诞节)", "ジュン(クリスマス)", "Jun(Xmas)", "Jun(Holiday)", "圣骑", "白骑", "圣黑骑", "圣诞黑骑"],
    ...
    1248: ["望(解放者)", "ノゾミ(リベレイター)", "Nozomi(Liberator)", "解望", "充电望", "白望", "女神望", "解放望"],
    1249: ["嘉夜(解放者)", "カヤ(リベレイター)", "Kaya(Liberator)", "解龙拳", "解放龙拳"],
    1250: ["矛依未(解放者)", "ムイミ(リベレイター)", "Muimi(Liberator)", "513", "解11", "解放511"],
    1251: ["珠希(咖啡厅)", "タマキ(カフェ)", "Tamaki(Cafe)", "猫咖", "咖啡猫", "咖猫剑"],
    1252: ["莫妮卡(咖啡厅)", "モニカ(カフェ)", "Monika(Cafe)", "莫妮咖", "咖二力", "猫二力"],
    1253: ["可可萝(游侠)", "コッコロ(レンジャー)", "Kokkoro(Ranger)", "游妈", "狗妈", "游侠可可萝", "游侠妈", "游白"],
    1254: ["栞(游侠)", "シオリ(レンジャー)", "Shiori(Ranger)", "游栞", "游侠栞", "游侠tp弓", "狼栞"],
    1255: ["姬塔(术士)", "ジータ(ウォーロック)", "Djeeta(Warlock)","魔姬", "魔吉", "魔法姬塔", "魔法吉他","魔塔", "法吉", "法鸡"],
    1256: ["碧卡拉", "ビカラ", "Vikala", "毗伽菈", "鼠鼠", "鼠大将", "鼠妹"],
    1257: ["花凛(炼金术师)", "カリン(アルケミスト)", "Karin(Alchemist)", "绿术", "绿发术士", "炼金恶魔", "魔绿"],
    1258: ["莉莉(堕落)", "リリ(フォールン)", "Riri(Fallen)", "莉莉"],

    1260: ["可璃亚(堕落)", "クリア(フォールン)", "Quria(Fallen)", "可璃亚"],
    1261: ["普蕾西亚(堕落)", "プレシア(フォールン)", "Precia(Fallen)", "普雷西娅(堕天使)", "普蕾西亚", "猪妹"],
    1262: ["伊莉亚(祭服)", "イリヤ(儀装束)", "Ilya(Costume)", "Illya(Ceremonial)", "伊莉亚(礼服)", "礼装伊莉亚", "礼装伊莉雅", "礼装伊利亚", "礼装yly", "礼服伊莉亚", "礼服伊莉雅", "礼服伊利亚", "礼服yly", "礼亚"],
    1263: ["雪(祭服)", "ユキ(儀装束)", "Yuki(Costume)", "Yuki(Ceremonial)", "雪(礼服)", "礼雪", "礼服雪", "礼服雪哥"],
    1264: ["克萝茜", "クローチェ", "Croce", "机娘"], 
    1265: ["莱拉耶尔", "ライラエル", "Lyrael", "lailael", "傲慢", "傲慢姬", "莱莱"],
    1266: ["似似花(夏日)", "ネネカ(サマー)", "Neneka(Summer)", "水花", "水448", "泳装448", "水似似花", "泳装似似花"],
    1267: ["秋乃(夏日)", "アキノ(サマー)", "Akino(Summer)", "水哈", "泳装秋乃", "水哈哈"],
    1268: ["优花梨(夏日)", "ユカリ(サマー)", "Yukari(Summer)", "水黄", "泳装黄骑", "由加莉(夏日)", "泳装酒鬼"],
    1269: ["兰法(夏日)", "ランファ(サマー)", "Ranpha(summer)", "泳装兰法", "水兰", "水兰法"],
    1270: ["空花(夏日)", "クウカ(サマー)", "Kuuka(summer)", "泳装空花", "水M", "水空花", "水抖M", "泳装抖M"],
    1271: ["忍(夏日)", "シノブ(サマー)", "Shinobu(summer)", "水忍", "泳装忍"],
    1272: ["凯留(插班生)", "キャル(編入生)", "Kyaru(Transfer Student)", "Karyl(Student)", "凯露(插班生)", "学猫", "偷腥猫"],
    1273: ["铃奈(插班生)", "スズナ(編入生)", "Suzuna(Transfer Student)", "Suzuna(Student)", "学暴", "雪豹"],

    1275: ["咲恋(萨拉萨利亚)", "サレン(サラサリア)", "Saren(Salasaria)", "火电", "火电站", "火舞旋风"],
    1276: ["流夏(萨拉萨利亚)", "ルカ(サラサリア)", "Ruka(Salasaria)", "流沙", "沙漠流夏"],
    1277: ["琳德", "リンド", "Lind", "龙姐"],
    1278: ["乌尔姆", "ヴルム", "Wurm", "龙妹"],
    1279: ["贪吃佩可(圣诞节)", "ペコリーヌ(クリスマス)", "Pecorine(Christmas)", "Pecorine(Holiday)", "圣吃", "剩饭", "圣诞吃货", "圣诞佩可"],
    1280: ["克蕾琪塔(圣诞节)", "クレジッタ(クリスマス)", "Creditta(Christmas)", "Creditta(Holiday)", "圣诞富婆", "圣婆", "圣富婆"],
    1281: ["静流(静流&璃乃)", "シズル(シズル&リノ)", "Shizuru(Shizuru&Rino)"],
    1282: ["璃乃(静流&璃乃)", "リノ(シズル&リノ)", "Rino(Shizuru&Rino)"],
    1283: ["祈梨(新年)", "イノリ(ニューイヤー)", "Inori(NewYear)", "春锤", "新春龙锤", "春八", "新春老八"],
    1284: ["初音(新年)", "ハツネ(ニューイヤー)", "Hatsune(NewYear)", "春星", "新春初音", "星春"],
    1285: ["霞(新年)", "カスミ(ニューイヤー)", "Kasumi(NewYear)", "春驴", "新春驴", "新春香澄", "新春霞"],

    1287: ["日和(星辰)", "ヒヨリ(アストラル)", "Hiyori(Astral)", "日和莉(星幽)", "日和(星幽)", "星猫", "⭐猫"],
    1288: ["怜(星辰)", "レイ(アストラル)", "Rei(Astral)", "怜(星幽)", "星怜", "⭐怜", "星剑"],
    1289: ["优衣(星辰)", "ユイ(アストラル)", "Yui(Astral)", "优衣(星幽)", "星优", "星u", "星优衣", "⭐优衣", "星田", "星衣", "⭐田", "⭐衣"],
    1290: ["厄里斯", "エリス", "Elis", "Eris", "els"],


    1293: ["优妮(冬日)", "ユニ(ウィンター)", "Yuni(Winter)", "水un", "水优妮", "水油腻", "水辈先"],
    1294: ["克萝依(冬日)", "クロエ(ウィンター)", "Kuroe(Winter)", "Chloe(Winter)", "水华哥", "水华"],

    1296: ["安涅默涅", "アネモネ", "Anemone", "银莲", "银莲花"],
    1297: ["涅妃涅菈", "ネフィ＝ネラ", "Nephi-Nera", "Nephi＝Nela", "涅妃·涅罗"],
    1298: ["真琴(指挥官)", "マコト(コマンダー)", "Makoto(Commander)", "战狼", "指狼", "指琴"],
    1299: ["惠理子(指挥官)", "エリコ(コマンダー)", "Eriko(Commander)", "战病", "病教", "娇官", "指病", "军病"],
    ...
    1307: ["镜华(春日)", "キョウカ(スプリング)", "Kyouka(Spring)", "Kyoka(Spring)", "花唯", "花仓唯", "花cw"],
    1308: ["铃莓(春日)", "スズメ(スプリング)", "Suzume(Spring)", "春日女仆", "花女仆"],
    1309: ["库露露", "クルル", "Kururu", "宝石兔", "庫露露"],
    1310: ["真布(梦想乐园)", "マホ(ドリームパーク)", "Maho(DreamPark)", "梦狐"],
    1311: ["涅娅(夏日)", "ネア(サマー)", "Nea(Summer)", "夏娅", "涅娅夏日", "夏日涅娅", "水涅娅", "涅亚夏日", "夏日涅亚", "水涅亚"],
    1312: ["美空(夏日)", "ミソラ(サマー)", "Misora(Summer)", "美空夏日", "夏日美空", "水美空"],



    1316: ["莉莉(夏日)", "リリ(サマー)", "Riri(Summer)", "水莉", "水莉莉", "夏日莉莉", "莉莉夏日"],
    1317: ["爱梅斯(夏日)", "アメス(サマー)", "Amesu(Summer)", "Ameth(Summer)", "水爱梅斯", "sms", "夏日爱梅斯", "水爱梅丝", "夏日爱梅丝"],
    1318: ["帆稀(夏日)", "ホマレ(サマー)", "Homare(Summer)", "水龙妈", "夏日龙妈"],
    1319: ["爱蜜莉雅(夏日)", "エミリア(サマー)", "Emiria(Summer)", "夏日艾米莉亚", "水emt", "水艾米", "水爱蜜", "夏日emt", "水莉雅"],
    1320: ["艾姬多娜(夏日)", "エキドナ(サマー)", "Echidna(Summer)", "夏日艾姬多娜", "夏日强欲", "水艾姬多娜", "水强欲", "强欲魔女", "强欲"],
    1321: ["雷姆(夏日)", "レム(サマー)", "Remu(Summer)", "蕾姆(夏日)", "夏日雷姆", "夏日蕾姆", "水蕾姆", "水雷姆", "水雷"],
    ...
    1811: ["静流&璃乃", "シズル&リノ", "Shizuru&Rino", "流璃", "琉璃"],
    1812: ["雪菲(公主)", "シェフィ(プリンセス)", "Shephy(Princess)", "Shefi(Princess)", "Sheffy(Princess)", "公主雪菲", "公冰", " 公雪", "公主冰龙", "公菲", "白菲"],
...
CHARA_PROFILE = {
    ...
    1264: {"名字": "克萝茜", "公会": "？？？", "生日": "11月11日", "年龄": "？？？", "身高": "170cm", "体重": "未换装时252kg", "血型": "？", "种族": "机械人族", "喜好": "睡午觉、对别人有益之事", "声优": "长谷川育美"},
    1265: {"名字": "莱拉耶尔", "公会": "吉欧‧提格尼亚", "生日": "1月17日", "年龄": "？？？", "身高": "162cm", "体重": "？？？kg", "血型": "？", "种族": "天使族", "喜好": "睡午觉、试吃新甜点", "声优": "河瀬茉希"},
    1277: {"名字": "琳德", "公会": "？？？", "生日": "2月5日", "年龄": "12", "身高": "145cm", "体重": "？？？kg", "血型": "？", "种族": "龙族", "喜好": "和妹妹一起度假", "声优": "丰田萌绘"},
    1278: {"名字": "乌尔姆", "公会": "？？？", "生日": "2月5日", "年龄": "12", "身高": "145cm", "体重": "？？？kg", "血型": "？", "种族": "龙族", "喜好": "偷懒、和姐姐一起度假", "声优": "关根明良"},
    1290: {"名字": "厄里斯", "公会": "？？？", "生日": "2月15日", "年龄": "？？？", "身高": "168cm", "体重": "？？？kg", "血型": "？", "种族": "人族", "喜好": "听骑士君说话", "声优": "桑島法子"},
    1296: {"名字": "安涅默涅", "公会": "？？？", "生日": "4月2日", "年龄": "13", "身高": "145cm", "体重": "39kg", "血型": "A", "种族": "妖魔人", "喜好": "打理花、拔刺", "声优": "立花日菜"},
    1297: {"名字": "涅妃涅菈", "公会": "？？？", "生日": "12月31日", "年龄": "？？？", "身高": "139cm", "体重": "？？？kg", "血型": "？", "种族": "妖魔人", "喜好": "过家家、人间观察", "声优": "太久保瑠美"},
