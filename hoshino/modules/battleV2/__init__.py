...
sv = Service('battleV2', use_priv=priv.NORMAL, manage_priv=priv.ADMIN,
...
# async def add_message_chudao(gid, uid, ev, bot, message, name):
#     text = "正在出刀"
#     title = '进行中'
#     count = '刀数'
#     full_time = '整刀'
...
#             name: str(name),
#         }
#         remain = int(zhoamu[gid][count][uid][full_time])
#         if remain > 0:
#             zhaomu[gid][message][uid] = content
#             zhaomu[gid][title].append(uid)
#             zhoamu[gid][count][uid][full_time] = remain - 1
#             savefile()
#             msg = f"成功添加信息,{name}开始对{message}进行挑战"
#             await bot.send(ev, msg, at_sender=True)
#             return
#         else:
#             msg = f"你今天的整刀已经出完了PS:尾刀使用指令:尾刀进TAT"
#             await bot.send(ev, msg, at_sender=True)
#             return
...
#     #     await bot.finish(ev, sv.help)
#     #     return
#     if len(message) == 1 and has_numbers(message):
#         await add_message_chudao(gid, uid, ev, bot, message, name)
...
#     if '1' in zhaomu[gid]:
#         del zhaomu[gid]['1'][uid]
#     if '2' in zhaomu[gid]:
#         del zhaomu[gid]['2'][uid]
#     if '3' in zhaomu[gid]:
#         del zhaomu[gid]['3'][uid]
#     if '4' in zhaomu[gid]:
#         del zhaomu[gid]['4'][uid]
#     if '5' in zhaomu[gid]:
#         del zhaomu[gid]['5'][uid]
#     savefile()
